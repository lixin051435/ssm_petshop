				...
				<tr align="center">
					...
					<div class="pagination">
								...
								<c:if test="${pageBean.page!=1}">
									<a href="${ pageContext.request.contextPath }/messages.action?page=1" class="firstPage">&nbsp;</a>
									<a
										href="${ pageContext.request.contextPath }/messages.action?page=${pageBean.page-1}"
								...
								<c:forEach var="i" begin="1" end="${pageBean.totlePage}">
									<c:choose>
										<c:when test="${pageBean.page!=i}">
											<a
												href="${pageContext.request.contextPath }/messages.action?page=${i}">
												${i}
											</a>
										</c:when>
										<c:otherwise>
								...
								<c:if test="${pageBean.page!=pageBean.totlePage}">
									<a class="nextPage"
										href="${ pageContext.request.contextPath }/messages.action?page=${pageBean.page+1}">&nbsp;</a>
									<a class="lastPage"
										href="${ pageContext.request.contextPath }/messages.action?page=${pageBean.totlePage}">&nbsp;</a>
								</c:if>
							</div>
					</td>
				</tr>
