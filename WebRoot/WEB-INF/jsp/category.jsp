	...
	<div class="container header">
		...
		<div class="container productList">
			...
			<div class="span18 last">
				<div id="result" class="result table clearfix">
					<ul>
						<c:forEach items="${pageBean.list}" var="pro">
							<li><a
								href="${pageContext.request.contextPath}/productFindByPid.action?pid=${pro.pid}">
				...
				<div class="pagination">
					...
					<c:if test="${pageBean.page!=1}">
						<a
							href="${ pageContext.request.contextPath }/findCategorySecond.action?cid=${cid}&page=1"
							class="firstPage">&nbsp;</a>
						<a
							href="${ pageContext.request.contextPath }/findCategorySecond.action?cid=${cid}&page=${pageBean.page-1}"
					...
					<c:forEach var="i" begin="1" end="${pageBean.totlePage}">
						<c:choose>
							<c:when test="${pageBean.page!=i}">
								<a
									href="${ pageContext.request.contextPath }/findCategorySecond.action?cid=${cid}&page=${i}">${i}</a>
							</c:when>
							<c:otherwise>
					...
					<c:if test="${pageBean.page!=pageBean.totlePage}">
						<a class="nextPage"
							href="${ pageContext.request.contextPath }/findCategorySecond.action?cid=${cid}&page=${pageBean.page+1}">&nbsp;</a>
						<a class="lastPage"
							href="${ pageContext.request.contextPath }/findCategorySecond.action?cid=${cid}&page=${pageBean.totlePage}">&nbsp;</a>
					</c:if>
				</div>
			</div>
			<div class="container footer">
				...
				<div class="span24">
					<div class="copyright">Copyright©爱宠宠物商城 版权所有</div>
				</div>
			</div>
</body>
</html>