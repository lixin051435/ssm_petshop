...
<div class="headertop_desc">
    ...
    <div class="account_desc">
        <div id="noLogin" style="display: block">
            <ul>
                <li>
                    <a href="javascript:forwordUrl('/regist.action');">
                        注册
                    </a>
                </li>
                <li>
                    <a href="javascript:forwordUrl('/login.action');">
                        登陆
                    </a>
                </li>
                <li>
                    <a href="javascript:forwordUrl('/myOrder.action?page=1');">
                        我的订单
                    </a>
                </li>
                <li>
                    <a href="javascript:forwordUrl('/myCart.action');">
        ...
        <div id="logined" style="display: none">
            <ul>
                ...
                <li>
                    <a href="javascript:forwordUrl('/userLogout.action');">
                        退出
                    </a>
                </li>
                <li>
    ...
    <div class="header_bottom">
        <div class="menu">
            <ul>
                <li id="index">
                    <a href="javascript:forwordUrl('/index.action');">
                        首页
                    </a>
                </li>
                <li id="about">
                    <a id="aboutA" href="javascript:forwordUrl('/about.action');">
                        关于我们
                    </a>
                </li>
                <li id="delivery">
                    <a href="javascript:forwordUrl('/delivery.action');">
                        发货说明
                    </a>
                </li> 
                <li id="contact">
                    <a href="javascript:forwordUrl('/contact.action');">
                        联系我们
                    </a>
                </li>
            </ul>
        ...
        <div class="search_box">
            <form method="post" action="<%=basePath%>/searchProduct.action"
