...
<body>
	<!--  -->
	<form id="userAction_save_do" name="Form1" action="${pageContext.request.contextPath}/admin/adminService_save.action"
		...
		<table cellSpacing="1" cellPadding="5" width="100%" align="center"
			...
			<tr>
				<td class="ta_01" align="center" bgColor="#afd1f3" colSpan="4"
					height="26"><strong><STRONG>添加服务</STRONG> </strong></td>
			</tr>
			<tr>
