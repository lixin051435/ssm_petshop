									...
									<c:forEach items="${pageBean.list}" var="o" varStatus="status">
										<tr onmouseover="this.style.backgroundColor = 'white'"
											...
											<td style="CURSOR: hand; HEIGHT: 22px" align="center"
												...
												<c:if test="${o.state==1}">
													已付款，<a href="${ pageContext.request.contextPath }/admin/adminOrder_updateState.action?oid=${o.oid}&status=2"><font color="blue">发货</font></a>
												</c:if>
												<c:if test="${o.state==2}">
													等待确认收货
												</c:if>
					...
					<tr align="center">
						<td colspan="7">
							...
							<c:if test="${pageBean.page != 1}">
								...
								<a href="${ pageContext.request.contextPath }/admin/adminOrder_findAllByPage.action?page=${pageBean.page-1}">上一页</a>|
							</c:if>
							<c:if test="${pageBean.page != pageBean.totlePage}">
								<a href="${ pageContext.request.contextPath }/admin/adminOrder_findAllByPage.action?page=${pageBean.page+1}">下一页</a>|
								<a href="${ pageContext.request.contextPath }/admin/adminOrder_findAllByPage.action?page=${pageBean.totlePage}">尾页</a>|
							</c:if>
						</td>
					</tr>
				</TBODY>
