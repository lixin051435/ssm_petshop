...
public class AdminController {
	...
	public String adminCategory_delete(@RequestParam int cid,HttpServletRequest request) throws Exception {
		...
		if(cid == 7||cid == 8) {
			request.getSession().setAttribute("message","对不起该类目不可以删除");
			return "redirect:/admin/adminCategory_findAll.action";
		}
	...
	//admin的服务管理
	@RequestMapping("/admin/adminService_findAllByPage")
	public String adminService_findAllByPage(@RequestParam int page, Model model,HttpServletRequest request)
			throws Exception {
		Adminuser adminuserLogin = (Adminuser) request.getSession().getAttribute("adminuserLogin");
		if(adminuserLogin==null){
			request.getSession().setAttribute("message","对不起您还没有登录");
		...
		PageBean<Product> allProPageBean = productService.findAllService(page);
		model.addAttribute("allProPageBean", allProPageBean);
	...
	@RequestMapping("/admin/adminService_addPage")
	public String adminService_addPage(Model model,HttpServletRequest request) throws Exception {
		Adminuser adminuserLogin = (Adminuser) request.getSession().getAttribute("adminuserLogin");
		if(adminuserLogin==null){
			request.getSession().setAttribute("message","对不起您还没有登录");
			return "admin/index";
	...
	public String adminProduct_save(Product product,HttpServletRequest request,MultipartFile file) throws Exception {
		...
		if (file != null) {
			...
			System.out.println(path+":"+product.getImage());
		}
	...
	@RequestMapping("/admin/adminService_save")
	public String adminService_save(Product product,HttpServletRequest request,MultipartFile file) throws Exception {
		Adminuser adminuserLogin = (Adminuser) request.getSession().getAttribute("adminuserLogin");
		if(adminuserLogin==null){
			request.getSession().setAttribute("message","对不起您还没有登录");
			return "admin/index";
		...
		productService.adminProduct_save(product);
		return "redirect:/admin/adminService_findAllByPage.action?page=1";
	}
	...
	@RequestMapping("admin/adminService_deletecs")
	public String adminService_deletecs(@RequestParam int pid,HttpServletRequest request) throws Exception{
		Adminuser adminuserLogin = (Adminuser) request.getSession().getAttribute("adminuserLogin");
		if(adminuserLogin==null){
			request.getSession().setAttribute("message","对不起您还没有登录");
			return "admin/index";
	 ...
	 * @throws Exception
	 */
	@RequestMapping("admin/adminService_edit")
	public String adminService_edit(@RequestParam int pid,Model model,HttpServletRequest request) throws Exception{
		Adminuser adminuserLogin = (Adminuser) request.getSession().getAttribute("adminuserLogin");
		if(adminuserLogin==null){
			request.getSession().setAttribute("message","对不起您还没有登录");
			return "admin/index";
	...
	@RequestMapping("/admin/adminService_update")
	public String adminService_update(Product product,HttpServletRequest request,MultipartFile file) throws Exception {
		Adminuser adminuserLogin = (Adminuser) request.getSession().getAttribute("adminuserLogin");
		if(adminuserLogin==null){
			request.getSession().setAttribute("message","对不起您还没有登录");
			return "admin/index";
